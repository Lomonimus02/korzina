...
export function LandingHero({ user }: LandingHeroProps) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center relative px-4 pb-24">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1400px] h-[600px] bg-gradient-to-t from-orange-500/50 via-purple-500/35 to-transparent opacity-90 blur-[120px] rounded-full pointer-events-none" />
