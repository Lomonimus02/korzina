...
const faqs = [
  ...
  {
    q: "Это платно?",
    a: "Есть бесплатный тариф — создавайте и редактируйте сайты без оплаты. Для скачивания проектов и расширенных возможностей доступен PRO тариф от 890₽ в месяц."
  },
  {
